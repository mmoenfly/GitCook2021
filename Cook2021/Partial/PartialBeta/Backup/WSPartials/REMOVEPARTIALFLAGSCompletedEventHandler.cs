...
// Type: Partial.WSPartials.REMOVEPARTIALFLAGSCompletedEventHandler
...
namespace Partial.WSPartials
{
  ...
  public delegate void REMOVEPARTIALFLAGSCompletedEventHandler(
    object sender,
    REMOVEPARTIALFLAGSCompletedEventArgs e);
}
