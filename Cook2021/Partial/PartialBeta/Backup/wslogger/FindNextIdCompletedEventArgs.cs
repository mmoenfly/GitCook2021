...
// Type: Partial.wslogger.FindNextIdCompletedEventArgs
...
namespace Partial.wslogger
{
  ...
  public class FindNextIdCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal FindNextIdCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
