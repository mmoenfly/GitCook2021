...
// Type: Partial.WSCustomer.GETCUSTOMERSPARTIALCompletedEventArgs
...
namespace Partial.WSCustomer
{
  ...
  public class GETCUSTOMERSPARTIALCompletedEventArgs : AsyncCompletedEventArgs
  {
    private object[] results;

    internal GETCUSTOMERSPARTIALCompletedEventArgs(
      object[] results,
      Exception exception,
      bool cancelled,
      object userState)
