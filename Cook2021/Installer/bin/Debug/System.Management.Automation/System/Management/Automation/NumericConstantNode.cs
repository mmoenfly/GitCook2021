...
// Type: System.Management.Automation.NumericConstantNode
...
{
  internal sealed class NumericConstantNode : ParseTreeNode
  {
    private readonly object _value;

    public NumericConstantNode(Token token)
    {
      this.NodeToken = token;
      this._value = this.NodeToken.Data;
