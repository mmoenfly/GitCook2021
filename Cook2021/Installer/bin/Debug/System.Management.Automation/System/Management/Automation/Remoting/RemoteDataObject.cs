...
// Type: System.Management.Automation.Remoting.RemoteDataObject
...
namespace System.Management.Automation.Remoting
{
  ...
  {
    private RemoteDataObject(
      RemotingDestination destination,
      RemotingDataType dataType,
      Guid runspacePoolId,
      Guid powerShellId,
      object data)
      : base(destination, dataType, runspacePoolId, powerShellId, data)
    {
    }

    internal static RemoteDataObject CreateFrom(
      RemotingDestination destination,
      RemotingDataType dataType,
      Guid runspacePoolId,
      Guid powerShellId,
