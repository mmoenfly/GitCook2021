...
// Type: System.Management.Automation.Runspaces.TypeTableLoadException
...
namespace System.Management.Automation.Runspaces
{
  ...
  public class TypeTableLoadException : RuntimeException
  {
    ...
    public TypeTableLoadException() => this.SetDefaultErrorRecord();
    ...
    protected void SetDefaultErrorRecord()
    {
      ...
      this.SetErrorId(typeof (TypeTableLoadException).FullName);
    }
